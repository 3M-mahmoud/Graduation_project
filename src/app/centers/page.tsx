      ...
      <div className="max-w-7xl mx-auto px-6 mt-12">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-xl font-bold text-slate-700">
            النتائج ({filteredCenters.length} سنتر)
          </h2>

          {isFiltered && (
            <button
              onClick={showAllCenters}
          ...
          <div
            onClick={handleSort}
            className="flex items-center gap-2 text-slate-500 bg-white px-4 py-2 rounded-xl border border-slate-100 cursor-pointer hover:bg-slate-50 transition"
          >
