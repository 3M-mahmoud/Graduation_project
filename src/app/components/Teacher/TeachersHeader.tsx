...
import imgHeroSection from "../../../assets/teacherHeroSection.png";
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-around gap-8">
        <div data-aos="fade-up" className="text-right">
          ...
          <p className="text-black text-lg lg:text-2xl/12 font-medium">
            تعلم مع نخبة من أفضل المدرسين الأونلاين <br />
            المتخصصين فى مصر
          </p>
        </div>
        <div data-aos="fade-up" className="relative w-64 h-48 md:w-96 md:h-72">
          <Image
            src={imgHeroSection}
            alt="Centers"
            fill
