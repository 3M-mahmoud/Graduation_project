  ...
  return (
    <div className="flex items-center gap-6" dir="rtl">
      ...
      >
        ...
        {showDropdown && (
          <div className="absolute left-0 top-full mt-2 w-72 bg-white rounded-2xl shadow-2xl border border-slate-100 z-[100] overflow-hidden p-6 animate-in fade-in zoom-in duration-200">
