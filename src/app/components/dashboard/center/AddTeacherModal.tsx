      ...
      <div className="bg-white rounded-[2.5rem] w-full max-w-[500px] max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in duration-300 border border-slate-100 scrollbar-hide">
        ...
        <form onSubmit={handleAddTeacher} className="p-6 space-y-5">
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  className="w-full p-3 bg-slate-50 border border-slate-100 rounded-xl text-right text-sm font-bold outline-none"
                />
              </div>
          ...
          <div className="flex flex-col gap-3 pt-4">
            <button
              type="submit"
              className="w-full py-3.5 bg-[#062D27] text-white rounded-xl font-black text-sm hover:bg-[#083a32] transition-all shadow-lg active:scale-95 cursor-pointer"
            >
              حفظ البيانات
            </button>
            <button
              type="button"
              onClick={onClose}
              className="w-full py-3.5 bg-slate-100 text-slate-500 rounded-xl font-bold text-sm hover:bg-slate-200 transition-all cursor-pointer"
            >
              إلغاء
            </button>
          </div>
